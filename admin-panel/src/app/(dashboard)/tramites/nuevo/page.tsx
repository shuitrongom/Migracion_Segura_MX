          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl">
                ...
                <div><label className="block text-xs font-semibold text-amber-300/70 mb-1 uppercase tracking-wide">Especifica *</label><select value={extranjero.especificaTramite} onChange={e => updateExtranjero('especificaTramite', e.target.value)} disabled={extranjero.propositoViaje !== 'Obtener permiso para trabajar'} className={`w-full px-3 py-2.5 border border-[#2a2a2a] bg-[#171717]/80 text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-amber-500 shadow-sm transition-all duration-300 hover:border-[#404040] ${extranjero.propositoViaje !== 'Obtener permiso para trabajar' ? 'bg-[#1f1f1f] text-white/30 cursor-not-allowed' : ''}`}><option value="">Selecciona</option><option value="Con empleador">Obtener permiso para trabajar con empleador</option><option value="Independiente/autoempleo">Obtener permiso para trabajar (actividades independientes/autoempleo)</option></select></div>
              </div>
            </div>
            )}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                ...
                <div><label className="block text-xs font-semibold text-amber-300/70 mb-1 uppercase tracking-wide">Estado civil actual</label><select value={extranjero.estadoCivil} onChange={e => updateExtranjero('estadoCivil', e.target.value)} className="w-full px-3 py-2.5 border border-[#2a2a2a] bg-[#171717]/80 text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-amber-500 shadow-sm transition-all duration-300 hover:border-[#404040]"><option value="">Selecciona</option>{ESTADOS_CIVILES.map(ec => <option key={ec.value} value={ec.value}>{ec.label}</option>)}</select></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl items-end">
                <div><label className="block text-xs font-semibold text-amber-300/70 mb-1 uppercase tracking-wide">País</label><select value={visaTemp.pais} onChange={e => setVisaTemp(prev => ({ ...prev, pais: e.target.value }))} className="w-full px-3 py-2.5 border border-[#2a2a2a] bg-[#171717]/80 text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-amber-500 shadow-sm transition-all duration-300 hover:border-[#404040]"><option value="">Selecciona</option>{PAISES.map(p => <option key={p} value={p}>{p}</option>)}</select></div>
              ...
              {solicitante.tipoPersona === 'Física' && (
                <div className="mt-6 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                    ...
                    <div><label className="block text-xs font-semibold text-amber-300/70 mb-1 uppercase tracking-wide">Nacionalidad actual *</label><select value={solicitante.nacionalidad} onChange={e => updateSolicitante('nacionalidad', e.target.value)} className="w-full px-3 py-2.5 border border-[#2a2a2a] bg-[#171717]/80 text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-amber-500 shadow-sm transition-all duration-300 hover:border-[#404040]"><option value="">Selecciona</option>{NACIONALIDADES.map(n => <option key={n} value={n}>{n}</option>)}</select></div>
                    <div><label className="block text-xs font-semibold text-amber-300/70 mb-1 uppercase tracking-wide">Tipo de documento *</label><select value={solicitante.tipoDocumento} onChange={e => updateSolicitante('tipoDocumento', e.target.value)} className="w-full px-3 py-2.5 border border-[#2a2a2a] bg-[#171717]/80 text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-amber-500 shadow-sm transition-all duration-300 hover:border-[#404040]"><option value="">Selecciona</option>{DOCUMENTOS_PERSONA_FISICA.map(d => <option key={d} value={d}>{d}</option>)}</select></div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                    ...
                    <div><label className="block text-xs font-semibold text-amber-300/70 mb-1 uppercase tracking-wide">Municipio o Alcaldía *</label><select value={solicitante.municipio} onChange={e => updateSolicitante('municipio', e.target.value)} className="w-full px-3 py-2.5 border border-[#2a2a2a] bg-[#171717]/80 text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-amber-500 shadow-sm transition-all duration-300 hover:border-[#404040]"><option value="">Selecciona</option>{(MUNICIPIOS_POR_ESTADO[solicitante.estado] || []).map(m => <option key={m} value={m}>{m}</option>)}</select></div>
              ...
              {solicitante.tipoPersona === 'Moral' && (
                <div className="mt-6 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                    ...
                    <div className="md:col-span-3"><label className="block text-xs font-semibold text-amber-300/70 mb-1 uppercase tracking-wide">Objeto de la empresa o giro comercial</label><textarea value={solicitante.moralGiroComercial} onChange={e => updateSolicitante('moralGiroComercial', e.target.value)} rows={3} className="w-full px-3 py-2.5 border border-[#2a2a2a] bg-[#171717]/80 text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-amber-500 shadow-sm transition-all duration-300 hover:border-[#404040] resize-none" /></div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                    ...
                    <div><label className="block text-xs font-semibold text-amber-300/70 mb-1 uppercase tracking-wide">Estado *</label><select value={solicitante.moralEstado} onChange={e => { updateSolicitante('moralEstado', e.target.value); updateSolicitante('moralMunicipio', ''); }} className="w-full px-3 py-2.5 border border-[#2a2a2a] bg-[#171717]/80 text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-amber-500 shadow-sm transition-all duration-300 hover:border-[#404040]"><option value="">Selecciona</option>{ESTADOS_MEXICO.map(est => <option key={est} value={est}>{est}</option>)}</select></div>
                    <div><label className="block text-xs font-semibold text-amber-300/70 mb-1 uppercase tracking-wide">Municipio o Alcaldía *</label><select value={solicitante.moralMunicipio} onChange={e => updateSolicitante('moralMunicipio', e.target.value)} className="w-full px-3 py-2.5 border border-[#2a2a2a] bg-[#171717]/80 text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-amber-500 shadow-sm transition-all duration-300 hover:border-[#404040]"><option value="">Selecciona</option>{(MUNICIPIOS_POR_ESTADO[solicitante.moralEstado] || []).map(m => <option key={m} value={m}>{m}</option>)}</select></div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                ...
                <div><label className="block text-xs font-semibold text-amber-300/70 mb-1 uppercase tracking-wide">Tipo de documento de identificación</label><select value={personaTemp.tipoDocumento} onChange={e => setPersonaTemp(prev => ({ ...prev, tipoDocumento: e.target.value }))} className="w-full px-3 py-2.5 border border-[#2a2a2a] bg-[#171717]/80 text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/40 focus:border-amber-500 shadow-sm transition-all duration-300 hover:border-[#404040]"><option value="">Selecciona</option>{DOCUMENTOS_IDENTIFICACION_PERSONA.map(d => <option key={d} value={d}>{d}</option>)}</select></div>
