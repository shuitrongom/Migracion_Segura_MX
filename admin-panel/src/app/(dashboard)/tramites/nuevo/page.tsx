...
export default function NuevoTramitePage() {
  ...
  const inputClass = (field: string) => `w-full px-3 py-2.5 border rounded-lg text-sm capitalize focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 ${hasError(field) ? 'border-red-500/60 bg-red-900/10' : 'border-[#3a3a3a] bg-[#252525] text-white hover:border-[#4a4a4a]'}`;
  const inputClassUpper = (field: string) => `w-full px-3 py-2.5 border rounded-lg text-sm uppercase focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 ${hasError(field) ? 'border-red-500/60 bg-red-900/10' : 'border-[#3a3a3a] bg-[#252525] text-white hover:border-[#4a4a4a]'}`;
  const inputClassEmail = (field: string) => `w-full px-3 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 ${hasError(field) ? 'border-red-500/60 bg-red-900/10' : 'border-[#3a3a3a] bg-[#252525] text-white hover:border-[#4a4a4a]'}`;
    ...
    if (step === 1) {
      ...
      if (selectedTramite?.tipo === 'visa') {
        ...
        if (solicitante.tipoPersona === 'Física') {
          ...
          if (extranjero.propositoViaje !== 'Oferta de empleo' && !solicitante.vinculoParentesco) errors['sol_vinculoParentesco'] = true;
  ...
  return (
    <div>
          ...
          <div className="bg-[#171717] rounded-2xl shadow-2xl w-full max-w-md mx-4 p-8 text-center animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-2.5 border border-[#3a3a3a] text-white/70 rounded-xl text-sm font-medium hover:bg-[#1a1a1a] transition-colors"
              >
                Empezar nuevo
              </button>
              <button
      ...
      <div className="flex items-center gap-4 mb-6">
        <Link href="/tramites" className="p-2 rounded-lg hover:bg-[#222222] text-amber-400 border border-cyan-900/50 transition-all hover:border-amber-500/50 hover:shadow-lg hover:shadow-amber-900/20"><ArrowLeft className="h-5 w-5" /></Link>
      ...
      <div className="dark-card p-6 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {TRAMITES_INM.map((t, idx) => (
                <button key={t.tipo} type="button" onClick={() => { setSelectedTramite(t); setStep(1); }} className={`group relative text-left p-6 rounded-2xl border transition-all duration-500 overflow-hidden bg-[#222222] border-[#3a3a3a]/50 hover:border-amber-500/60 hover:shadow-xl hover:shadow-amber-900/20 hover:scale-[1.03] animate-fade-in-up stagger-${idx + 1}`} style={{ opacity: 0 }}>
                  {/* Número decorativo */}
                  <div className="absolute top-3 right-3 flex items-center justify-center h-8 w-8 rounded-full text-xs font-bold transition-all duration-500 bg-[#222222] text-white/70 border border-[#3a3a3a] group-hover:bg-cyan-500/20 group-hover:text-amber-400 group-hover:border-cyan-500/50 group-hover:shadow-lg group-hover:shadow-cyan-500/20">{idx + 1}</div>
                  {/* Barra lateral decorativa con glow */}
                  <div className="absolute left-0 top-0 bottom-0 w-1 rounded-l-2xl transition-all duration-500 bg-[#222222] group-hover:bg-gradient-to-b group-hover:from-amber-400 group-hover:to-amber-600 group-hover:shadow-[0_0_8px_rgba(0,212,255,0.5)]" />
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl">
                ...
                <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Especifica *</label><select value={extranjero.especificaTramite} onChange={e => updateExtranjero('especificaTramite', e.target.value)} disabled={extranjero.propositoViaje !== 'Obtener permiso para trabajar'} className={`w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a] ${extranjero.propositoViaje !== 'Obtener permiso para trabajar' ? 'bg-[#222222] text-white/70 cursor-not-allowed' : ''}`}><option value="">Selecciona</option><option value="Con empleador">Obtener permiso para trabajar con empleador</option><option value="Independiente/autoempleo">Obtener permiso para trabajar (actividades independientes/autoempleo)</option></select></div>
              </div>
            </div>
            )}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                ...
                <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Estado civil actual</label><select value={extranjero.estadoCivil} onChange={e => updateExtranjero('estadoCivil', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]"><option value="">Selecciona</option>{ESTADOS_CIVILES.map(ec => <option key={ec.value} value={ec.value}>{ec.label}</option>)}</select></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                ...
                <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Número interior</label><input type="text" value={extranjero.domNumeroInterior} onChange={e => updateExtranjero('domNumeroInterior', e.target.value)} className="w-full px-3 py-2.5 border border-[#333333] bg-[#222222] rounded-lg text-sm capitalize focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-400 shadow-sm hover:shadow transition-shadow" /></div>
                <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Lada</label><input type="text" value={extranjero.domLada} onChange={e => updateExtranjero('domLada', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Teléfono fijo</label><input type="text" value={extranjero.domTelefonoFijo} onChange={e => updateExtranjero('domTelefonoFijo', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
              </div>
            </div>
            )}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl items-end">
                <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">País</label><select value={visaTemp.pais} onChange={e => setVisaTemp(prev => ({ ...prev, pais: e.target.value }))} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]"><option value="">Selecciona</option>{PAISES.map(p => <option key={p} value={p}>{p}</option>)}</select></div>
                <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Número</label><input type="text" value={visaTemp.numero} onChange={e => setVisaTemp(prev => ({ ...prev, numero: e.target.value }))} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
              ...
              {solicitante.tipoPersona === 'Física' && (
                <div className="mt-6 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                    ...
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Nombre(s) *</label><input type="text" value={solicitante.nombre} onChange={e => updateSolicitante('nombre', e.target.value)} className="w-full px-3 py-2.5 border border-[#333333] bg-[#222222] rounded-lg text-sm capitalize focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-400 shadow-sm hover:shadow transition-shadow" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Apellido(s) *</label><input type="text" value={solicitante.apellidos} onChange={e => updateSolicitante('apellidos', e.target.value)} className="w-full px-3 py-2.5 border border-[#333333] bg-[#222222] rounded-lg text-sm capitalize focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-400 shadow-sm hover:shadow transition-shadow" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Nacionalidad actual *</label><select value={solicitante.nacionalidad} onChange={e => updateSolicitante('nacionalidad', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]"><option value="">Selecciona</option>{NACIONALIDADES.map(n => <option key={n} value={n}>{n}</option>)}</select></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Tipo de documento *</label><select value={solicitante.tipoDocumento} onChange={e => updateSolicitante('tipoDocumento', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]"><option value="">Selecciona</option>{DOCUMENTOS_PERSONA_FISICA.map(d => <option key={d} value={d}>{d}</option>)}</select></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Número de documento *</label><input type="text" value={solicitante.numeroDocumento} onChange={e => updateSolicitante('numeroDocumento', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    {extranjero.propositoViaje !== 'Oferta de empleo' && (<div className="md:col-span-3"><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Vínculo o parentesco entre el solicitante y el extranjero *</label><select value={solicitante.vinculoParentesco} onChange={e => updateSolicitante('vinculoParentesco', e.target.value)} className={inputClass('sol_vinculoParentesco')}><option value="">Selecciona</option>{VINCULOS_PARENTESCO.map(v => <option key={v} value={v}>{v}</option>)}</select><ErrorMsg field="sol_vinculoParentesco" /></div>)}
                  </div>

                  <h4 className="text-sm font-semibold text-white/90 border-b pb-1 pt-2">Domicilio de la persona física</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Código postal *</label><input type="text" value={solicitante.codigoPostal} onChange={e => updateSolicitante('codigoPostal', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Estado *</label><select value={solicitante.estado} onChange={e => { updateSolicitante('estado', e.target.value); updateSolicitante('municipio', ''); }} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]"><option value="">Selecciona</option>{ESTADOS_MEXICO.map(est => <option key={est} value={est}>{est}</option>)}</select></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Municipio o Alcaldía *</label><select value={solicitante.municipio} onChange={e => updateSolicitante('municipio', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]"><option value="">Selecciona</option>{(MUNICIPIOS_POR_ESTADO[solicitante.estado] || []).map(m => <option key={m} value={m}>{m}</option>)}</select></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Colonia *</label><input type="text" value={solicitante.colonia} onChange={e => updateSolicitante('colonia', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Calle *</label><input type="text" value={solicitante.calle} onChange={e => updateSolicitante('calle', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Número exterior *</label><input type="text" value={solicitante.numeroExterior} onChange={e => updateSolicitante('numeroExterior', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Número interior</label><input type="text" value={solicitante.numeroInterior} onChange={e => updateSolicitante('numeroInterior', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Lada</label><input type="text" value={solicitante.lada} onChange={e => updateSolicitante('lada', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
              ...
              {solicitante.tipoPersona === 'Moral' && (
                <div className="mt-6 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                    ...
                    <div className="md:col-span-2"><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Nombre o razón social *</label><input type="text" value={solicitante.moralRazonSocial} onChange={e => updateSolicitante('moralRazonSocial', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    <div className="md:col-span-3"><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Sector o rama de actividad</label><select value={solicitante.moralSector} onChange={e => updateSolicitante('moralSector', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]"><option value="">Selecciona</option>{SECTORES_ACTIVIDAD.map(s => <option key={s} value={s}>{s}</option>)}</select></div>
                    <div className="md:col-span-3"><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Objeto de la empresa o giro comercial</label><textarea value={solicitante.moralGiroComercial} onChange={e => updateSolicitante('moralGiroComercial', e.target.value)} rows={3} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a] resize-none" /></div>
                  </div>

                  <h4 className="text-sm font-semibold text-white/90 border-b pb-1 pt-2">Domicilio de la persona moral</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Código postal *</label><input type="text" value={solicitante.moralCodigoPostal} onChange={e => updateSolicitante('moralCodigoPostal', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Estado *</label><select value={solicitante.moralEstado} onChange={e => { updateSolicitante('moralEstado', e.target.value); updateSolicitante('moralMunicipio', ''); }} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]"><option value="">Selecciona</option>{ESTADOS_MEXICO.map(est => <option key={est} value={est}>{est}</option>)}</select></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Municipio o Alcaldía *</label><select value={solicitante.moralMunicipio} onChange={e => updateSolicitante('moralMunicipio', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]"><option value="">Selecciona</option>{(MUNICIPIOS_POR_ESTADO[solicitante.moralEstado] || []).map(m => <option key={m} value={m}>{m}</option>)}</select></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Colonia *</label><input type="text" value={solicitante.moralColonia} onChange={e => updateSolicitante('moralColonia', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Calle *</label><input type="text" value={solicitante.moralCalle} onChange={e => updateSolicitante('moralCalle', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Número exterior *</label><input type="text" value={solicitante.moralNumeroExterior} onChange={e => updateSolicitante('moralNumeroExterior', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Número interior</label><input type="text" value={solicitante.moralNumeroInterior} onChange={e => updateSolicitante('moralNumeroInterior', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Lada</label><input type="text" value={solicitante.moralLada} onChange={e => updateSolicitante('moralLada', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Teléfono fijo</label><input type="text" value={solicitante.moralTelefonoFijo} onChange={e => updateSolicitante('moralTelefonoFijo', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                  </div>

                  <h4 className="text-sm font-semibold text-white/90 border-b pb-1 pt-2">Datos del acta constitutiva</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                    <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Número de acta constitutiva</label><input type="text" value={solicitante.moralNumeroActa} onChange={e => updateSolicitante('moralNumeroActa', e.target.value)} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl">
                <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Clave Única de Registro de Población (CURP)</label><input type="text" value={personaTemp.curp} onChange={e => setPersonaTemp(prev => ({ ...prev, curp: e.target.value.toUpperCase() }))} className="w-full px-3 py-2 border border-[#3a3a3a] rounded-lg text-sm uppercase focus:outline-none focus:ring-2 focus:ring-amber-500" maxLength={18} />{personaTemp.curp && validateCurp(personaTemp.curp) && <p className="text-[11px] text-red-500 mt-1">{validateCurp(personaTemp.curp)}</p>}</div>
                <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Nombre(s) *</label><input type="text" value={personaTemp.nombre} onChange={e => setPersonaTemp(prev => ({ ...prev, nombre: e.target.value }))} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Apellido(s) *</label><input type="text" value={personaTemp.apellidos} onChange={e => setPersonaTemp(prev => ({ ...prev, apellidos: e.target.value }))} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
                ...
                <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Tipo de documento de identificación</label><select value={personaTemp.tipoDocumento} onChange={e => setPersonaTemp(prev => ({ ...prev, tipoDocumento: e.target.value }))} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]"><option value="">Selecciona</option>{DOCUMENTOS_IDENTIFICACION_PERSONA.map(d => <option key={d} value={d}>{d}</option>)}</select></div>
                <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Número de documento</label><input type="text" value={personaTemp.numeroDocumento} onChange={e => setPersonaTemp(prev => ({ ...prev, numeroDocumento: e.target.value }))} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" /></div>
              </div>
            ...
            <div>
              ...
              <textarea value={extranjero.comentarios} onChange={e => updateExtranjero('comentarios', e.target.value)} rows={4} className="w-full max-w-4xl px-3 py-2 border border-[#3a3a3a] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 resize-none" />
        ...
        {/* Step 2: Solicitud INM — rendered as fullscreen overlay outside this card */}
        ...
        {step === 3 && (
          <div>
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              ...
              <button type="button" onClick={() => setShowCitaModal(true)} className="flex items-center gap-2 px-4 py-2.5 border border-[#3a3a3a] text-white/70 rounded-lg text-sm font-medium hover:bg-[#1a1a1a] transition-colors">
          ...
          <div>
            ...
            <div className="max-w-2xl space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="number" value={pagoData.monto} onChange={e => setPagoData(prev => ({ ...prev, monto: e.target.value }))} className="w-full pl-7 pr-3 py-2.5 border border-[#333333] bg-[#222222] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-400 shadow-sm hover:shadow transition-shadow" placeholder="0.00" min="0" step="0.01" />
                  </div>
                </div>
                <div>
                  <label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Método de pago *</label>
                  <select value={pagoData.metodoPago} onChange={e => setPagoData(prev => ({ ...prev, metodoPago: e.target.value }))} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]">
              ...
              <div>
                ...
                <input type="text" value={pagoData.referencia} onChange={e => setPagoData(prev => ({ ...prev, referencia: e.target.value }))} className="w-full px-3 py-2.5 border border-[#3a3a3a] bg-[#252525] text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 shadow-sm transition-all duration-300 hover:border-[#4a4a4a]" placeholder="Ej: REF-2025-001234" />
              </div>
      ...
      {/* Step 2: Fullscreen overlay — Solicitud INM */}
      {step === 2 && selectedTramite && (
        <div className="fixed inset-0 z-50 bg-[#0a0a0a] flex flex-col">
          {/* Top bar */}
          <div className="flex items-center justify-between px-4 py-3 border-b border-[#2a2a2a] bg-[#111111] flex-shrink-0">
            <div className="flex items-center gap-3">
              <button type="button" onClick={() => setStep(1)} className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-amber-400 hover:text-amber-300 hover:bg-[#1a1a1a] rounded-lg transition-all border border-transparent hover:border-[#3a3a3a]">
                <ArrowLeft className="h-4 w-4" /> Volver
              </button>
              <div className="h-5 w-px bg-[#3a3a3a]" />
              <FileText className="h-4 w-4 text-amber-500" />
              <h2 className="text-sm font-semibold text-white">Solicitud INM — {selectedTramite.nombre}</h2>
            </div>
            <div className="flex items-center gap-2">
              {STEPS.map((label, i) => (
                <div key={label} className="flex items-center gap-1">
                  <div className={`h-6 w-6 rounded-full flex items-center justify-center text-[10px] font-semibold ${i < step ? 'bg-emerald-500 text-white' : i === step ? 'bg-amber-500 text-white' : 'bg-[#222] text-white/50 border border-[#3a3a3a]'}`}>
                    {i < step ? <Check className="h-3 w-3" /> : i + 1}
                  </div>
                  {i < STEPS.length - 1 && <div className={`w-4 h-0.5 ${i < step ? 'bg-emerald-400' : 'bg-[#2a2a2a]'}`} />}
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="flex flex-1 overflow-hidden">
            {/* LEFT sidebar — Ficha del Extranjero */}
            <div className="w-[320px] flex-shrink-0 border-r border-[#2a2a2a] bg-[#111111] overflow-y-auto">
              <div className="p-4">
                <h4 className="text-xs font-semibold text-white/70 uppercase mb-3">Ficha del Extranjero</h4>
                <p className="text-[10px] text-white/50 mb-4">Haz clic en cualquier dato para copiarlo</p>
                <div className="space-y-4">
                  {/* Propósito de viaje */}
                  {extranjero.propositoViaje && (
                    <div>
                      <p className="text-[10px] font-semibold text-amber-500 uppercase border-b border-[#2a2a2a] pb-1 mb-2">Propósito de viaje</p>
                      <button type="button" onClick={() => copyToClipboard(extranjero.propositoViaje)} className="w-full text-left p-1.5 rounded hover:bg-[#1a1a1a] border border-transparent hover:border-[#3a3a3a] transition-all group">
                      ...
                      <button type="button" onClick={() => copyToClipboard(extranjero.especificaTramite)} className="w-full text-left p-1.5 rounded hover:bg-[#1a1a1a] border border-transparent hover:border-[#3a3a3a] transition-all group mt-1">
                  ...
                  {(extranjero.nombre || extranjero.apellidos) && (
                    <div>
                      <p className="text-[10px] font-semibold text-amber-500 uppercase border-b border-[#2a2a2a] pb-1 mb-2">Datos del extranjero</p>
                      <div className="space-y-1">
                        {[
                          ...
                          <button key={item.label} type="button" onClick={() => copyToClipboard(item.value)} className="w-full text-left p-1.5 rounded hover:bg-[#1a1a1a] border border-transparent hover:border-[#3a3a3a] transition-all group">
                  ...
                  {(extranjero.paisNacimiento || extranjero.estadoProvinciaNacimiento) && (
                    <div>
                      <p className="text-[10px] font-semibold text-amber-500 uppercase border-b border-[#2a2a2a] pb-1 mb-2">Lugar de nacimiento</p>
                      <div className="space-y-1">
                        {[
                  ...
                  {(extranjero.documentoIdentificacion || extranjero.numeroDocumento) && (
                    <div>
                      <p className="text-[10px] font-semibold text-amber-500 uppercase border-b border-[#2a2a2a] pb-1 mb-2">Pasaporte / Documento</p>
                      <div className="space-y-1">
                        {[
                  ...
                  {extranjero.domCodigoPostal && (
                    <div>
                      <p className="text-[10px] font-semibold text-amber-500 uppercase border-b border-[#2a2a2a] pb-1 mb-2">Domicilio en México</p>
                      <div className="space-y-1">
                        {[
                  ...
                  {(extranjero.actividadPrincipal || extranjero.expulsadoMexico) && (
                    <div>
                      <p className="text-[10px] font-semibold text-amber-500 uppercase border-b border-[#2a2a2a] pb-1 mb-2">Información adicional</p>
                      <div className="space-y-1">
                        {[
                  ...
                  {(extranjero.telefono || extranjero.solicitanteEmail) && (
                    <div>
                      <p className="text-[10px] font-semibold text-amber-500 uppercase border-b border-[#2a2a2a] pb-1 mb-2">Correo electrónico</p>
                      <div className="space-y-1">
                        {[
                  ...
                  {visas.length > 0 && (
                    <div>
                      <p className="text-[10px] font-semibold text-amber-500 uppercase border-b border-[#2a2a2a] pb-1 mb-2">Visas del extranjero</p>
                      <div className="space-y-1">
                        {visas.map((v, i) => (
                          <button key={i} type="button" onClick={() => copyToClipboard(`${v.pais} - ${v.numero}`)} className="w-full text-left p-1.5 rounded hover:bg-[#1a1a1a] border border-transparent hover:border-[#3a3a3a] transition-all group">
                  ...
                  {solicitante.tipoPersona && (
                    <div>
                      <p className="text-[10px] font-semibold text-amber-500 uppercase border-b border-[#2a2a2a] pb-1 mb-2">Solicitante</p>
                      <div className="space-y-1">
                        {[
                  ...
                  {personasAutorizadas.length > 0 && (
                    <div>
                      <p className="text-[10px] font-semibold text-amber-500 uppercase border-b border-[#2a2a2a] pb-1 mb-2">Personas autorizadas</p>
                      <div className="space-y-1">
                        {personasAutorizadas.map((p, i) => (
                          <button key={i} type="button" onClick={() => copyToClipboard(`${p.nombre} ${p.apellidos}`)} className="w-full text-left p-1.5 rounded hover:bg-[#1a1a1a] border border-transparent hover:border-[#3a3a3a] transition-all group">
            ...
            {/* RIGHT area — iframe + bottom bar */}
            <div className="flex-1 flex flex-col overflow-hidden">
              {/* Iframe taking full height */}
              <div className="flex-1 overflow-hidden">
                <iframe src={selectedTramite.urlSolicitud} className="w-full h-full border-0" title="Formulario INM" />
              </div>

              {/* Bottom bar: pieza, clave, PDF, open in new tab, next button */}
              <div className="flex-shrink-0 border-t border-[#2a2a2a] bg-[#111111] px-4 py-3">
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 flex-1">
                    <div className="flex-1 max-w-[180px]">
                      <label className="block text-[10px] font-semibold text-amber-200/70 mb-0.5 uppercase tracking-wide">Nº de Pieza *</label>
                      <input type="text" value={numeroPieza} onChange={e => setNumeroPieza(e.target.value)} className="w-full px-2.5 py-1.5 border border-[#3a3a3a] bg-[#1a1a1a] text-white rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400" placeholder="0000011969016" />
                    </div>
                    <div className="flex-1 max-w-[140px]">
                      <label className="block text-[10px] font-semibold text-amber-200/70 mb-0.5 uppercase tracking-wide">Clave *</label>
                      <input type="text" value={contrasenaINM} onChange={e => setContrasenaINM(e.target.value.toUpperCase())} className="w-full px-2.5 py-1.5 border border-[#3a3a3a] bg-[#1a1a1a] text-white rounded-lg text-sm font-mono uppercase focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400" placeholder="QFCSA" />
                    </div>
                    <div className="flex-1 max-w-[200px]">
                      <label className="block text-[10px] font-semibold text-amber-200/70 mb-0.5 uppercase tracking-wide">PDF Solicitud *</label>
                      <label className="flex items-center gap-1.5 px-2.5 py-1.5 border border-[#3a3a3a] bg-[#1a1a1a] rounded-lg text-xs text-white/70 hover:bg-[#222] cursor-pointer transition-colors">
                  ...
                  <div className="flex items-center gap-2 ml-auto">
                    <a href={selectedTramite.urlSolicitud} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 px-3 py-1.5 text-xs text-amber-400 hover:text-amber-300 border border-[#3a3a3a] hover:border-amber-500/50 rounded-lg transition-all">
                      <ExternalLink className="h-3.5 w-3.5" /> Nueva pestaña
                    </a>
                    <button type="button" onClick={handleNext} className="flex items-center gap-1.5 px-5 py-2 bg-gradient-to-r from-amber-500 to-amber-600 text-white rounded-lg text-sm font-semibold hover:from-amber-400 hover:to-amber-500 shadow-lg shadow-amber-500/20 transition-all">
          ...
          <div className="bg-[#171717] rounded-2xl shadow-2xl p-6 w-full max-w-md mx-4">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input type="time" value={citaData.horaInicio} onChange={e => setCitaData(prev => ({ ...prev, horaInicio: e.target.value }))} className="w-full px-3 py-2.5 border border-[#333333] bg-[#222222] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 shadow-sm" />
              </div>
              <div><label className="block text-xs font-semibold text-amber-200/70 mb-1 uppercase tracking-wide">Notas</label><textarea value={citaData.notas} onChange={e => setCitaData(prev => ({ ...prev, notas: e.target.value }))} rows={3} className="w-full px-3 py-2.5 border border-[#333333] bg-[#222222] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 shadow-sm resize-none" placeholder="Ej: Entrega de documentos originales en oficina" /></div>
            </div>
            <div className="flex justify-end gap-3 mt-6">
              <button type="button" onClick={() => setShowCitaModal(false)} className="px-4 py-2 border border-[#3a3a3a] text-white/70 rounded-lg text-sm font-medium hover:bg-[#1a1a1a]">Cancelar</button>
