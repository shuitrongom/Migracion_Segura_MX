...
export default function VisaForm({ form, solicitante, updateForm, updateSolicitante }: VisaFormProps) {
  ...
  return (
    <View>
      ...
      <Field label="Número"><TextInput style={styles.input} value={visaTemp.numero} onChangeText={(v) => setVisaTemp(prev => ({ ...prev, numero: v }))} placeholder="Número de visa" placeholderTextColor="#4A6FA5" /></Field>
      ...
      {solicitante.tipoPersona === 'Física' && (
        <View>
          ...
          <Field label="CURP"><TextInput style={styles.input} value={solicitante.curp} onChangeText={(v) => updateSolicitante('curp', v.toUpperCase())} placeholder="18 caracteres" placeholderTextColor="#4A6FA5" maxLength={18} autoCapitalize="characters" /></Field>
          <Field label="RFC"><TextInput style={styles.input} value={solicitante.rfc} onChangeText={(v) => updateSolicitante('rfc', v.toUpperCase())} placeholder="13 caracteres" placeholderTextColor="#4A6FA5" maxLength={13} autoCapitalize="characters" /></Field>
          <Field label="Nombre(s) *"><TextInput style={styles.input} value={solicitante.nombre} onChangeText={(v) => updateSolicitante('nombre', v)} placeholder="Nombre(s)" placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Apellido(s) *"><TextInput style={styles.input} value={solicitante.apellidos} onChangeText={(v) => updateSolicitante('apellidos', v)} placeholder="Apellido(s)" placeholderTextColor="#4A6FA5" /></Field>
          ...
          <Field label="Número de documento *"><TextInput style={styles.input} value={solicitante.numeroDocumento} onChangeText={(v) => updateSolicitante('numeroDocumento', v)} placeholder="Número" placeholderTextColor="#4A6FA5" /></Field>
          ...
          <Field label="Código postal *"><TextInput style={styles.input} value={solicitante.codigoPostal} onChangeText={(v) => updateSolicitante('codigoPostal', v)} placeholder="CP" placeholderTextColor="#4A6FA5" keyboardType="number-pad" /></Field>
          ...
          <Field label="Municipio o Alcaldía *"><TextInput style={styles.input} value={solicitante.municipio} onChangeText={(v) => updateSolicitante('municipio', v)} placeholder="Municipio" placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Colonia *"><TextInput style={styles.input} value={solicitante.colonia} onChangeText={(v) => updateSolicitante('colonia', v)} placeholder="Colonia" placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Calle *"><TextInput style={styles.input} value={solicitante.calle} onChangeText={(v) => updateSolicitante('calle', v)} placeholder="Calle" placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Número exterior *"><TextInput style={styles.input} value={solicitante.numeroExterior} onChangeText={(v) => updateSolicitante('numeroExterior', v)} placeholder="Núm. ext." placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Número interior"><TextInput style={styles.input} value={solicitante.numeroInterior} onChangeText={(v) => updateSolicitante('numeroInterior', v)} placeholder="Opcional" placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Lada"><TextInput style={styles.input} value={solicitante.lada} onChangeText={(v) => updateSolicitante('lada', v)} placeholder="Lada" placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Teléfono fijo"><TextInput style={styles.input} value={solicitante.telefonoFijo} onChangeText={(v) => updateSolicitante('telefonoFijo', v)} placeholder="Teléfono" placeholderTextColor="#4A6FA5" /></Field>
        </View>
      )}
      ...
      {solicitante.tipoPersona === 'Moral' && (
        <View>
          ...
          <Field label="RFC *"><TextInput style={styles.input} value={solicitante.moralRfc} onChangeText={(v) => updateSolicitante('moralRfc', v.toUpperCase())} placeholder="12 caracteres" placeholderTextColor="#4A6FA5" maxLength={12} autoCapitalize="characters" /></Field>
          <Field label="Nombre o razón social *"><TextInput style={styles.input} value={solicitante.moralRazonSocial} onChangeText={(v) => updateSolicitante('moralRazonSocial', v)} placeholder="Razón social" placeholderTextColor="#4A6FA5" /></Field>
          ...
          <Field label="Objeto de la empresa o giro comercial"><TextInput style={[styles.input, { height: 70, textAlignVertical: 'top' }]} value={solicitante.moralGiroComercial} onChangeText={(v) => updateSolicitante('moralGiroComercial', v)} placeholder="Giro comercial" placeholderTextColor="#4A6FA5" multiline /></Field>

          <Text style={styles.subsectionTitle}>Domicilio de la persona moral</Text>
          <Field label="Código postal *"><TextInput style={styles.input} value={solicitante.moralCodigoPostal} onChangeText={(v) => updateSolicitante('moralCodigoPostal', v)} placeholder="CP" placeholderTextColor="#4A6FA5" keyboardType="number-pad" /></Field>
          ...
          <Field label="Municipio o Alcaldía *"><TextInput style={styles.input} value={solicitante.moralMunicipio} onChangeText={(v) => updateSolicitante('moralMunicipio', v)} placeholder="Municipio" placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Colonia *"><TextInput style={styles.input} value={solicitante.moralColonia} onChangeText={(v) => updateSolicitante('moralColonia', v)} placeholder="Colonia" placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Calle *"><TextInput style={styles.input} value={solicitante.moralCalle} onChangeText={(v) => updateSolicitante('moralCalle', v)} placeholder="Calle" placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Número exterior *"><TextInput style={styles.input} value={solicitante.moralNumeroExterior} onChangeText={(v) => updateSolicitante('moralNumeroExterior', v)} placeholder="Núm. ext." placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Número interior"><TextInput style={styles.input} value={solicitante.moralNumeroInterior} onChangeText={(v) => updateSolicitante('moralNumeroInterior', v)} placeholder="Opcional" placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Lada"><TextInput style={styles.input} value={solicitante.moralLada} onChangeText={(v) => updateSolicitante('moralLada', v)} placeholder="Lada" placeholderTextColor="#4A6FA5" /></Field>
          <Field label="Teléfono fijo"><TextInput style={styles.input} value={solicitante.moralTelefonoFijo} onChangeText={(v) => updateSolicitante('moralTelefonoFijo', v)} placeholder="Teléfono" placeholderTextColor="#4A6FA5" /></Field>

          <Text style={styles.subsectionTitle}>Datos del acta constitutiva</Text>
          <Field label="Número de acta constitutiva"><TextInput style={styles.input} value={solicitante.moralNumeroActa} onChangeText={(v) => updateSolicitante('moralNumeroActa', v)} placeholder="Número" placeholderTextColor="#4A6FA5" /></Field>
      ...
      <TextInput style={[styles.input, { height: 80, textAlignVertical: 'top' }]} value={form.comentarios} onChangeText={(v) => updateForm('comentarios', v)} placeholder="Si lo deseas, puedes agregar algún comentario a la solicitud (opcional)" placeholderTextColor="#4A6FA5" multiline />
